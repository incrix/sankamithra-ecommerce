...
export const metadata = {
  ...
  description:
    "Buy crackers wholesale from a Sivakasi shop. Slab pricing for retailers, dealers and event buyers, bulk stock through the season and licensed transport arranged across India.",
  ...
  openGraph: {
    ...
    description: "Slab pricing for dealers and bulk buyers, straight from Sivakasi.",
    url: `${SITE_URL}/wholesale`, siteName: BUSINESS.name, type: "website",
  },
};

const FAQS = [
  { q: "Do you sell crackers wholesale?", a: "Yes. We supply shops, distributors and event buyers from our Sivakasi stock, with slab rates that improve as order size increases. Send your item list on WhatsApp to +91 94892 39970 for a quotation." },
